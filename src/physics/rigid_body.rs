use crate::{geometry::vector::Vector3d, geometry::polygon::Polygon, physics::constants::GRAVITY};
...
pub fn update(masses: &[f32], forces: &mut [Vector3d], accelerations: &mut [Vector3d], velocities: &mut [Vector3d], shapes: &mut [Polygon], index: usize, dt: f32) {
