...
pub fn update(shapes: &mut [crate::geometry::polygon::Polygon], masses: &[f32], forces: &mut [Vector3d], accelerations: &mut [Vector3d], velocities: &mut [Vector3d], index: usize, dt: f32) {
