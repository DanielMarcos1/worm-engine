use crate::{geometry::vector::Vector3d, physics::constants::GRAVITY};

pub fn apply_force(world: &mut crate::physics::world::World, index: usize, force: Vector3d) {
    world.forces[index] = world.forces[index].add(&force);
}

pub fn apply_gravity(world: &mut crate::physics::world::World, index: usize) {
    let force = GRAVITY.scale(world.masses[index]);
    world.forces[index] = world.forces[index].add(&force);
}

pub fn update(world: &mut crate::physics::world::World, index: usize, dt: f32) {
