...
impl World {
    ...
    pub fn add_body(&mut self, shape: Polygon, mass: f32) {
        ...
        self.positions.push(Vector3d::zero()); // Initial position approximation for center if needed, or leave to shapes
    ...
    pub fn step(&mut self) {
        ...
        let chunk_size = 4;
        let remainder = self.shapes.len() % chunk_size;
        let exact_len = self.shapes.len() - remainder;
        ...
        let num_bodies = self.shapes.len();
