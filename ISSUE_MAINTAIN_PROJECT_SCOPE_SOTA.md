---
name: "Strategic Plan: Maintain Scope & Achieve SOTA"
title: "[Strategic Portfolio Plan] Maintain v1.0.0 Scope while Achieving State-of-the-Art (SOTA)"
labels: ["strategic-plan", "sota", "scope-management"]
---

# Strategic Portfolio Plan: Worm Engine SOTA Integration (v1.0.0 Roadmap)

## Executive Summary
**Strategic Objectives**: Evolve the Worm Engine from a functional 3D physics engine into a state-of-the-art (SOTA), high-performance solution without derailing the core v1.0.0 roadmap. Align our technical milestones to deliver hyper-performance, deterministic simulation, and memory efficiency, positioning us for the anticipated market shift toward highly scalable, data-oriented multiplayer experiences.
...
- **Multithreading and SIMD Vectorization**: [Budget: 20% R&D, Timeline: v0.6.0, Expected ROI: Secures performance leadership, Strategic Impact: Maximizes CPU utilization using `rayon` and `wide` (avoiding unstable `std::simd`). Essential to compete with Havok/Jolt.]
  - *Resource allocation and success metrics*: 1 Systems Engineer; success measured by linear scaling up to 16 threads.
...
- **Continuous Collision Detection (CCD)**: [Budget: 15% R&D, Timeline: v0.4.0, Expected ROI: 20% market share increase, Strategic Impact: Prevents "tunneling" at high velocities (0% tunneling at 1000m/s). Critical for fast-paced action titles and AAA adoption.]
  - *Resource allocation and success metrics*: 2 Physics Engineers; success measured by 0% tunneling at 1000m/s velocities. Implemented as a modular add-on to not block 1.0.0.
