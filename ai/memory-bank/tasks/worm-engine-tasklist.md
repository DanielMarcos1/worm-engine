...
**Target Timeline**: v1.0.0 Roadmap (incremental milestones from v0.4.0 to v1.0.0)
...
**Special Instructions**: Ensure DOD and SIMD refactoring explicitly use the `wide` crate on a Structure of Arrays (SoA) layout. Array of Structures (AoS) SIMD is avoided on individual math primitives. Modularize GPU and CCD features.
**Timeline Expectations**: Milestones aligned with v0.4.0, v0.6.0, and v0.7.0/v1.0.0 roadmap phases, maintaining 95% on-time delivery.
